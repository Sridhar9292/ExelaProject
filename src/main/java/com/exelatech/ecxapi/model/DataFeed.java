...
public class DataFeed {
	...
	public String toString() {
		return "DataFeed{" + "feedID=" + feedID + ", feedName='" + feedName + '\'' + ", vendorCode='" + vendorCode
				+ '\'' + ", filePattern='" + filePattern + '\'' + ", fileType='" + fileType + '\'' + ", expectedTime='"
				+ expectedTime + '\'' + ", fileSchedule='" + fileSchedule + '\'' + ", singleMulti='" + singleMulti
				+ '\'' + ", gracePeriod=" + gracePeriod + ", feedDocID='" + feedDocID + '\'' + ", feedExpected="
				+ feedExpected + ", actualTime='" + actualTime + '\'' + ", rowStatus='" + rowStatus + '\''
				+ ", dataFeedWorkflow=" + dataFeedWorkflow + ", feedSummary=" + feedSummary + ", receivedTime="
				+ receivedTime + '\'' + ", importedTime=" + importedTime + '\'' + ", exportedTime=" + exportedTime
				+ '\'' + '}';
	}
}