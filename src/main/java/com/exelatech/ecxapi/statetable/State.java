...
public class State {
	public enum Type {
		INITIAL, PROCESSING, FINAL, ISSUE, WARNING, ERROR, NULL
	};
	...
	public State setType(Type type) {
		this.type = type;
		return this;
	}
	...
	public boolean equals(Object s) {
		return (((State) s).name.equalsIgnoreCase(this.name) && (((State) s).getType() == this.type));
	}
}
