...
public class Dashboard extends BaseObject  {
	 ...
	 * 
	 * public List<DataFeed> getRemitFeeds() { return remitFeeds; }
	 * 
	 * public void setRemitFeeds(List<DataFeed> remitFeeds) { this.remitFeeds =
	 * remitFeeds; }
	 */
    ...
    public boolean equals(Object o) {
        ...
        if (!date.equals(dashboard.date)) return false;
...
//                if(m.matches() && (dataFeed.getFeedDocID()==null || dataFeed.getFeedDocID().equals(""))){
...
//    }
	...
	public String toString() {
		return "Dashboard [id=" + id + ", date=" + date + ", holiday=" + holiday + ", remitFeeds=" + remitFeeds + "]";
	}

//    public String getDashboardDate(){
//        return DateUtil.convertStringUTCDateToStringUTCDate(date, "yyyyMMdd", "yyyy-MM-dd");
//    }
}