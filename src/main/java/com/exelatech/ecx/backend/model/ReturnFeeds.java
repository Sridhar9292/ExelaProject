...
public class ReturnFeeds {
	...
	public boolean equals(Object o) {
		...
		if (!feedDocID.equals(that.feedDocID)) return false;
    ...
    public String toString() {
        return "ReturnFeeds{" +
                ...
                ", netAmount=" + netAmount +
                ", addendumRecord='" + addendumRecord + '\'' +
                ", addendumSequence=" + addendumSequence +
                ", addendaTypeCode=" + addendaTypeCode +
                ", returnReasonCode='" + returnReasonCode + '\'' +
                ", addendaDate='" + addendaDate + '\'' +
                ", addendumInformation='" + addendumInformation + '\'' +
                ", vendorRejectCode='" + vendorRejectCode + '\'' +
                ", vendorRejectDescription='" + vendorRejectDescription + '\'' +
                ...
                ", feedDocAuthor='" + feedDocAuthor + '\'' +
                ", feedDocType='" + feedDocType + '\'' +
                '}';
    }
}
